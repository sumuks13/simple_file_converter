...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseBean<String>> handleInvalidUrlException(Exception e){
        log.error("Error: ",e);
        ApiResponseBean<String> responseBody = ApiResponseBean.failure("Invalid url or unreachable host");
